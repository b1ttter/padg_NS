...
class MapView:
    ...
    def create_combobox(self, parent):
        ...
        categories = ["Uczelnie", "Kierunki", "Pracownicy", "Studenci"]
    ...
    def create_university_frame(self, parent):
        ...
        self.button_add_university = Button(formularz, text="Dodaj Uczelnię", background="green", font=("Arial", 10, "bold"), fg="white", activebackground="lightgreen")
    ...
    def create_class_frame(self, parent):
        ...
        Label(frame, text="LISTA KIERUNKÓW").grid(row=0, column=0, sticky=W)
        ...
        formularz = Frame(frame)
        formularz.grid(row=1, column=1, sticky=N)
        Label(formularz, text="Formularz Kierunku").grid(row=0, column=0, columnspan=2)
        ...
        self.button_add_class = Button(formularz, text="Dodaj Kierunek", background="green", font=("Arial", 10, "bold"), fg="white", activebackground="lightgreen")
    ...
    def create_employee_frame(self, parent):
        ...
        self.button_add_employee = Button(formularz, text="Dodaj Pracownika", background="green", font=("Arial", 10, "bold"), fg="white", activebackground="lightgreen")
    ...
    def create_student_frame(self, parent):
        ...
        Label(formularz, text="Kierunek:").grid(row=4, column=0, sticky=W)
        ...
        self.button_add_student = Button(formularz, text="Dodaj Studenta", background="green", font=("Arial", 10, "bold"), fg="white", activebackground="lightgreen")
        ...
        Label(map_filter_frame, text="Kierunek:").grid(row=2, column=0, sticky=W)
